...
namespace challenge.Services
{
    public class MovieService : IMovieService
    {
        ...
        public async Task<IEnumerable<Movie>> GetMovies(MovieQueryFilters filters)
        {
            ...
            if (filters.GenerID != null)
            {
                movies = movies.Where(x => x.Geners.Any(g => g.GenerID == filters.GenerID));
            }
        ...
        public async Task<bool> UpdateMovies(int id, MoviesForUpdateDTO movieDto)
        {
            ...
            if (movieDto.Rating is not null)
            {
                movieEntity.Rating = movieDto.Rating.Value;
            }
